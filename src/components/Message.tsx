...
import { Button, ListItem, ListItemText, Stack, Table, TableCell, TableRow, TextField, Typography } from '@mui/material';
                ...
                <ListItemText
                    ...
                    secondary={(
                        <Stack direction="row" justifyContent="space-between">
                            ...
                            <Button onClick={handleOpen} sx={{ marginLeft: 2, height: 20 }}>
                                Share
                            </Button>
                            <Modal
                                open={open}
                            ...
                            >
                                <Box sx={style}>
                                    ...
                                    />
                                    <Button onClick={() => {peerId && sendMessage({
                                        peerId,
                                        signedMessage: {
                                            message: {
                                                data: text,
                                            ...
                                            encrypted_hashes: [...encryptedHashes].reverse(),
                                        }});
                                        setOpen(false);
                                    }}>
                                        Share
                    ...
                    sx={{ borderRadius: 2, padding: 2, bgcolor: 'rgba(255, 255, 255, 0.12)' }}
                />
            </ListItem>
        </Stack>
    )
